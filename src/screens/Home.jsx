...
const Home = () => {
  ...
  return (
    ...
    >
      <ImageBackground
        source={{
          uri: "https://images.pexels.com/photos/459976/pexels-photo-459976.jpeg",
        }}
        resizeMode="cover"
        style={{
          height: screenHeight,
      ...
      >
        <Text
          ...
          style={{ fontFamily: "Palanquin", fontSize: 30 }}
        >
        ...
        {keyData.length === 0 ? (
          <View style={{ paddingTop: lh }}>
            <Text
              className="text-fuchsia-950 text-center "
              style={{ fontFamily: "Palanquin", fontSize: 25 }}
            >
              {" "}
              Welcome To
            </Text>
            ...
            >
              {" "}
              click on Add to create your Milestones{" "}
            </Text>
          </View>
        ) : (
